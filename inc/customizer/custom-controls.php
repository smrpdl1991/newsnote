<?php
/**
 * NewsNote Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class NewsNote_Custom_Control extends WP_Customize_Control {
		protected function get_newsnote_resource_url() {
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Custom_Section extends WP_Customize_Section {
		protected function get_newsnote_resource_url() {
			if( strpos( wp_normalize_path( __DIR__ ), wp_normalize_path( WP_PLUGIN_DIR ) ) === 0 ) {
				// We're in a plugin directory and need to determine the url accordingly.
				return plugin_dir_url( __DIR__ );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Image_Checkbox_Custom_Control extends NewsNote_Custom_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_style( 'NewsNote-custom-controls-css', $this->get_newsnote_resource_url() . 'inc/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Text_Radio_Button_Custom_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Image_Radio_Button_Custom_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Single_Accordion_Custom_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'NewsNote-custom-controls-js', $this->get_newsnote_resource_url() . 'inc/assets/js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'NewsNote-custom-controls-css', $this->get_newsnote_resource_url() . 'inc/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Simple_Notice_Custom_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Slider_Custom_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'NewsNote-custom-controls-js', $this->get_newsnote_resource_url() . 'inc/assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'NewsNote-custom-controls-css', $this->get_newsnote_resource_url() . 'inc/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Toggle_Switch_Custom_control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Sortable_Repeater_Custom_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Dropdown_Select2_Custom_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'NewsNote-select2-js', $this->get_newsnote_resource_url() . 'js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'NewsNote-custom-controls-js', $this->get_newsnote_resource_url() . 'inc/assets/js/customizer.js', array( 'NewsNote-select2-js' ), '1.0', true );
			wp_enqueue_style( 'NewsNote-custom-controls-css', $this->get_newsnote_resource_url() . 'inc/assets/css/customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'NewsNote-select2-css', $this->get_newsnote_resource_url() . 'inc/assets/css/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Dropdown_Posts_Custom_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_TinyMCE_Custom_control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['NewsNotetinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['NewsNotetinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['NewsNotemediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Google_Font_Select_Custom_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->fontList = $this->newsnote_getGoogleFonts( 'all' );
			// Decode the default json font value
			$this->fontValues = json_decode( $this->value() );
			// Find the index of our default font within our list of Google fonts
			$this->fontListIndex = $this->newsnote_getFontIndex( $this->fontList, $this->fontValues->font );
		}
		/**
		 * Enqueue our scripts and styles
		 */
		public function enqueue() {
			wp_enqueue_script( 'NewsNote-select2-js', $this->get_newsnote_resource_url() . 'inc/assets/js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'NewsNote-custom-controls-js', $this->get_newsnote_resource_url() . 'inc/assets/js/customizer.js', array( 'NewsNote-select2-js' ), '1.0', true );
			wp_enqueue_style( 'NewsNote-custom-controls-css', $this->get_newsnote_resource_url() . 'inc/assets/css/customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'NewsNote-select2-css', $this->get_newsnote_resource_url() . 'inc/assets/css/select2.min.css', array(), '4.0.13', 'all' );
		}
		...
		public function to_json() {
			parent::to_json();
			$this->json['NewsNotefontslist'] = $this->fontList;
		}
		/**
		 * Render the control in the customizer
		 */
		public function render_content() {
			...
			if( !empty($this->fontList) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight & style for regular text', 'newsnote' ) ?></div>
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'newsnote' ) ?> <italic><?php esc_html_e( 'italic text', 'newsnote' ) ?></italic></div>
					<div class="weight-style">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'newsnote' ) ?> <strong><?php esc_html_e( 'bold text', 'newsnote' ) ?></strong></div>
					<div class="weight-style">
		 ...
		 */
		public function newsnote_getFontIndex( $haystack, $needle ) {
		 ...
		 */
		public function newsnote_getGoogleFonts( $count = 30 ) {
			// Google Fonts json generated from https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=YOUR-API-KEY
			$fontFile = $this->get_newsnote_resource_url() . 'inc/google-fonts-alphabetical.json';
			if ( $this->fontOrderBy === 'popular' ) {
				$fontFile = $this->get_newsnote_resource_url() . 'inc/google-fonts-popularity.json';
			}
	 ...
	 */
	class NewsNote_Customize_Alpha_Color_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'NewsNote-custom-controls-js', $this->get_newsnote_resource_url() . 'inc/assets/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'NewsNote-custom-controls-css', $this->get_newsnote_resource_url() . 'inc/assets/css/customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class NewsNote_Alpha_Color_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_style( 'NewsNote-custom-controls-css', $this->get_newsnote_resource_url() . 'inc/assets/css/customizer.css', array(), '1.0', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', $this->get_newsnote_resource_url() . 'js/wp-color-picker-alpha.js', array( 'wp-color-picker' ), '1.0', true );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class NewsNote_Pill_Checkbox_Custom_Control extends NewsNote_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'NewsNote-custom-controls-js', $this->get_newsnote_resource_url() . 'inc/assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.1', true );
			wp_enqueue_style( 'NewsNote-custom-controls-css', $this->get_newsnote_resource_url() . 'inc/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 *
	 */
	class NewsNote_Upsell_Section extends NewsNote_Custom_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'NewsNote-upsell';
		/**
		 * The Upsell URL
		 */
		public $url = '';
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'NewsNote-custom-controls-js', $this->get_newsnote_resource_url() . 'js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'NewsNote-custom-controls-css', $this->get_newsnote_resource_url() . 'inc/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="newsnote_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	if ( ! function_exists( 'newsnote_url_sanitization' ) ) {
		function newsnote_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'newsnote_switch_sanitization' ) ) {
		function newsnote_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'newsnote_radio_sanitization' ) ) {
		function newsnote_radio_sanitization( $input, $setting ) {
	 ...
	 */
	if ( ! function_exists( 'newsnote_sanitize_integer' ) ) {
		function newsnote_sanitize_integer( $input ) {
			return (int) $input;
		}
	}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'newsnote_text_sanitization' ) ) {
		function newsnote_text_sanitization( $input ) {
			if ( strpos( $input, ',' ) !== false) {
				$input = explode( ',', $input );
			}
			if( is_array( $input ) ) {
	 ...
	 */
	if ( ! function_exists( 'newsnote_array_sanitization' ) ) {
		function newsnote_array_sanitization( $input ) {
			if( is_array( $input ) ) {
				foreach ( $input as $key => $value ) {
					$input[$key] = sanitize_text_field( $value );
				}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'newsnote_hex_rgba_sanitization' ) ) {
		function newsnote_hex_rgba_sanitization( $input, $setting ) {
			...
			if ( false === strpos( $input, 'rgba' ) ) {
				...
				$input = 'rgba(' . newsnote_in_range( $red, 0, 255 ) . ',' . newsnote_in_range( $green, 0, 255 ) . ',' . newsnote_in_range( $blue, 0, 255 ) . ',' . newsnote_in_range( $alpha, 0, 1 ) . ')';
			}
			return $input;
		}
	}
	 ...
	 */
	if ( ! function_exists( 'newsnote_in_range' ) ) {
		function newsnote_in_range( $input, $min, $max ){
			if ( $input < $min ) {
				$input = $min;
			}
			if ( $input > $max ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'newsnote_google_font_sanitization' ) ) {
		function newsnote_google_font_sanitization( $input ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'newsnote_date_time_sanitization' ) ) {
		function newsnote_date_time_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'newsnote_range_sanitization' ) ) {
		function newsnote_range_sanitization( $input, $setting ) {
			...
			return newsnote_in_range( $number, $min, $max );
		}
	}
